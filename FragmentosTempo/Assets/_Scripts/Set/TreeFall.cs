...
public class TreeFall : MonoBehaviour
{
    ...
    public void ForceFall(GameObject colliderObject)            // Método para iniciar a queda da árvore.
    {
        ...
        {
            if (colliderObject.CompareTag("Trice"))             // Verificar se colidiu com o Triceratops.
            {
    ...
    {
        if (hasFallen && collision.gameObject.CompareTag("Trice"))                          // Verifica se a árvore já caiu e se colidiu com o Triceratops.
        {
    ...
    {
        if (hasFallen && triceTouching && collision.gameObject.CompareTag("Trice"))         // Verifica se a árvore já caiu e se o Triceratops saiu da colisão.
        {
